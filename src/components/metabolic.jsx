...
import { METABOLIC_INPUT_FIELDS, METABOLIC_INITIAL_VALUES } from "../constant/constant";

const Metabolic = () => {
  const [values, setValues] = useState(METABOLIC_INITIAL_VALUES);
    ...
    <div className="flex flex-col self-stretch rounded-[9px] bg-neutral-800">
      ...
      <div className="p-3 sm:p-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {METABOLIC_INPUT_FIELDS.map((item) => (
